...
/***/ function(module, exports, __webpack_require__) {
	...
	$(document).ready(function () {
	  ...
	  $(".container").append($("<div class=\"alert alert-success symbol-stat\" role=\"alert\"></div>").text("" + total.ok + " symbols successfully rendered by itself.")).append($("<div class=\"alert alert-info symbol-stat\" role=\"alert\"></div>").html("" + total.example + " functions successfully rendered by providing an example(mostly from Dr. Carol JVF Burns's <a href=\"http://www.onemathematicalcat.org/MathJaxDocumentation/TeXSyntax.htm\">TEX Commands available in MathJax</a>).")).append($("<div class=\"alert alert-danger symbol-stat\" role=\"alert\"></div>").html("" + total.error + " symbols/functions failed to render. <a href=\"https://github.com/Khan/KaTeX/blob/master/CONTRIBUTING.md\">Help KaTeX to add them.</a>")).append($table);
	});
